...
INSERT INTO `tbl_users` (`id`, `name`, `pwd`, `address`,`task`, `phone`, `email`, `type`, `status`, `bdate`) VALUES
(15, 'admin', 'admin', 'some addresses','task', '11223344', 'myemail@gmail.com', 'admin', 'active', '2016-12-20 10:00:08');
