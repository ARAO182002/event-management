  ...
  <form role="form" action="<?php echo WEB_ROOT; ?>views/process.php?cmd=create" method="post">
    <div class="box-body">
      ...
      <div class="form-group">
		...
		<span id="sprytf_task">
        <textarea name="task" class="form-control input-sm" placeholder="Task"></textarea>
		<span class="textareaRequiredMsg">Task assigned is required.</span>
...
var sprytf_task 	= new Spry.Widget.ValidationTextarea("sprytf_task", {minChars:10, isRequired:true, validateOn:["blur", "change"]});
